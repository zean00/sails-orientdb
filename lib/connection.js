...
module.exports = (function () {
    ...
    */
    ...
    dbHelper.prototype.createEdge = function (from, to, options, cb) {
        if(options['@class']){
            if(!this.db.class.cached.names[options['@class']]){

                this.db.class.create(options['@class'],'E').then(function(r,e){
                      console.log('Edge class ' + options['@class'] + ' created');
                      //console.log(r);
                });
            }
        }
    ...
    dbHelper.prototype.traverse = function(collection,options,cb){
        var query = this.db.traverse().from(collection);

        if(options)query=query.where(options);
    ...
    /*
    dbHelper.prototype.createIndex = function(collection,propertyName,cb){
    ...
    */
    ...
    dbHelper.prototype.query = function(options,cb){
        var q = options.query;
        var l = options.limit;
        var p = options.param;
        if(!q){
          ...
          if(l)params.limit = l;
          console.log(q);
          this.db.query(q,params).then(function(result){
            cb(null,result);
          });
        }
    };
