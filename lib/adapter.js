...
module.exports = (function () {
    ...
    var adapter = {
        ...
        getDB:function(conn,collection,cb){
          return connections[conn].getDB(cb);
        },

        traverse:function(connection, collection, options, cb){
          return connections[connection].traverse(collection, options, cb);
        },

        query:function(connection, collection, options, cb){
          return connections[connection].query(options, cb);
        },
